...
import com.example.wangpicture.infrastructure.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.example.wangpicture.infrastructure.api.imagesearch.ImageSearchApiFacade;
...
import com.example.wangpicture.interfaces.assembler.PictureAssembler;
...
import com.example.wangtu.manager.auth.annotation.SaSpaceCheckPermission;
...
import com.example.wangpicture.interfaces.vo.picture.PictureTagCategory;
...
//            // 已经改为使用注解鉴权
//            //User loginUser = userApplicationService.getLoginUser(request);
//            // pictureApplicationService.checkPicture(loginUser,picture);
//            space = spaceApplicationService.getById(spaceId);
//            ThrowUtils.throwIf(space == null, ErrorCode.NOT_FOUND_ERROR,"空间不存在");
//
//        }
//        User loginUser = userApplicationService.getById(space.getUserId());
...
//        if (cashedValue != null) {
//            // 缓存命中
//            Page<PictureVO> cachedPage = JSONUtil.toBean(cashedValue, Page.class);
//
...
// 获取封装类
    ...
    /**
    * @Description: 颜色搜图 
    * @Param: [searchPictureByColorRequest, request]
    * @return: com.example.wangtu.common.BaseResponse<java.util.List<com.example.wangpicture.interfaces.vo.picture.PictureVO>>
    * @Author: trudh
    * @Date: 2025/9/19
    **/
    ...
    /**
    * @Description: 批量编辑上传
    * @Param: [batchEditUploadRequest, request]
    * @return: com.example.wangtu.common.BaseResponse<java.lang.Boolean>
    * @Author: trudh
    * @Date: 2025/9/19
    **/
    @PostMapping("/edit/batch")
    @SaSpaceCheckPermission(value = SpaceUserPermissionConstant.PICTURE_EDIT)
    public BaseResponse<Boolean> batchEditUpload(@RequestBody PictureEditByBatchRequest pictureEditByBatchRequest, HttpServletRequest request) {
