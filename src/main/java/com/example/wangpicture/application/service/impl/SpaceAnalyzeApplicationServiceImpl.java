...
public class SpaceAnalyzeApplicationServiceImpl implements SpaceAnalyzeApplicationService {
    ...
    * @return: java.util.List<com.example.wangpicture.interfaces.vo.space.analyze.SpaceSizeAnalyzeResponse>
    * @Author: trudh
    * @Date: 2025/9/21
    **/
    @Override
    ...
    public List<Space> getSpaceRankAnalyze(SpaceRankAnalyzeRequest spaceRankAnalyzeRequest, User loginUser) {
        ...
        // 检查权限
        ThrowUtils.throwIf(!loginUser.isAdmin(), ErrorCode.NO_AUTH_ERROR, "没有管理员权限");
        // 构造查询条件
